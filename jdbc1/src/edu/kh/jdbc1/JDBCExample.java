...
public class JDBCExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// --> 생략해도 자동으로 메모리 로드가 진행됨
			
			// 2. 연결 정보를 담은 Connection을 생성
			//  -> DriverManager 객체를 이용해서 Connection 객체를 얻어옴!
			
			String type = "jdbc:oracle:thin:@"; // JDBC 드라이버의 종류
			String ip = "localhost";   // DB 서버 컴퓨터 IP
			// localhost == 127.0.0.1 (loop back ip) 자기 자신을 가르킴
			...
			// 3. SQL 작성
			// ** JAVA에서 작성되는 SQL구문 마지막에 ;(세미콜론)을 찍지 않아야 한다! **
			...
			// 5. 생성된 Statement 객체에 sql을 적재하여 실행 후
